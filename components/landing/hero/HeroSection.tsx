    ...
    <>
      <div className="lg:col-span-3 col-span-6 mt-[0rem] ">
        <div className="flex flex-col lg:items-start items-center justify-center">
          <p className="text-24 md:text-6xl mb-5 text-white font-bold">
              <span className="text-orange-400">Studying </span> Online is now
              much easier
          </p>
          <p className="text-22 mb-5 text-white font-light">
        ...
        <div className="flex items-center justify-center lg:justify-start">
          <button className="bg-[#7ECBCC] font-poppins text-22 text-white font-bold py-2 px-5 rounded-full mr-5">
            Join for free
          </button>
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-[#252641] text-22 ml-2">
              Watch how it works
            </p>
          </div>
        </div>
